...
//#region node_modules/.nitro/vite/services/ssr/assets/router-B_grjZL3.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var style_default = "/assets/style-BBn8io7Z.css";
...
var $$splitComponentImporter$4 = () => import("./routes-Cr4y5V9p.mjs");
var Route$6 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./about-CD4tSuiG.mjs");
...
var $$splitComponentImporter$2 = () => import("./contact-CAJFAdH4.mjs");
...
var $$splitComponentImporter$1 = () => import("./projects-DcFSRaCd.mjs");
...
var $$splitComponentImporter = () => import("./services-ZdMfbUZH.mjs");
...
function getSmtpConfig() {
	const smtpUser = processModule.env.SMTP_USER?.trim();
	const smtpPass = processModule.env.SMTP_PASS?.trim();
	const receiverEmail = processModule.env.RECEIVER_EMAIL?.trim();
...
async function sendContactEmail(input) {
	...
	const { default: nodemailer } = await import("../_libs/nodemailer+unenv.mjs").then((n) => /* @__PURE__ */ __toESM(n.t()));
